...
class Constants(object):
    ...
    FRIDA_PORT = 27042
    DEBUG_PORT = 12345
    REPOS = ['coolstar.org', 'cydia.radare.org', 'build.frida.re']
    ...
    DEVICE_SETUP = {
        ...
        'TOOLS': {
            ...
            'IOSTOOLCHAIN': {'COMMAND': 'perl', 'PACKAGES': ['org.coolstar.iostoolchain'], 'REPO': 'https://coolstar.org/publicrepo/', 'LOCAL': None, 'SETUP': None},
